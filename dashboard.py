...
class IMS:
    def __init__(self, root):
        ...
        #========_Date & Time Bar_==========
        self.clock_label = Label(self.root, text="My Shop Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS", font=("times new roman",15),bg="#4d636d", fg="white")
        self.clock_label.place(x=0,y=70, relwidth=1, height=40)

        #========_Side Navigation Bar_=========
        self.menu_logo = Image.open(r"C:\Inventory Management System\images/shop.jpeg")
        ...
        #==========_Menu Label_============
        img0 = Image.open(r"C:\Inventory Management System\images/rg.png")
        ...
        img2 = Image.open(r"C:\Inventory Management System\images/emp.png")
        img2 = img2.resize((50, 40), Image.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        img3 = Image.open(r"C:\Inventory Management System\images/sup.png")
        img3 = img3.resize((50, 40), Image.LANCZOS)
        self.photoimg3 = ImageTk.PhotoImage(img3)

        img4 = Image.open(r"C:\Inventory Management System\images/cat.png")
        img4 = img4.resize((50, 40), Image.LANCZOS)
        self.photoimg4 = ImageTk.PhotoImage(img4)

        img5 = Image.open(r"C:\Inventory Management System\images/prod.png")
        img5 = img5.resize((50, 40), Image.LANCZOS)
        self.photoimg5 = ImageTk.PhotoImage(img5)

        img6 = Image.open(r"C:\Inventory Management System\images/sales.png")
        img6 = img6.resize((50, 40), Image.LANCZOS)
        self.photoimg6 = ImageTk.PhotoImage(img6)

        img7 = Image.open(r"C:\Inventory Management System\images/serv1.png")
        img7 = img7.resize((50, 40), Image.LANCZOS)
        self.photoimg7 = ImageTk.PhotoImage(img7)

        img8 = Image.open(r"C:\Inventory Management System\images/exit.png")
        ...
        self.menu_logo2 = Image.open(r"C:\Inventory Management System\images/meet.jpg")
        ...
        # ========_Footer_==========
        footer = Label(self.root, text="My Shop - Inventory Management System | Developed by Dreams-Tech Solutions\n Technical Issue Contact: 680-305-815", font=("times nw roman", 10,"bold"), bg="#4d636d", fg="white")
...
#==========================================================================================================================
    ...
    def update_content(self):
        ...
        try:
            ...
            bill = len(os.listdir(r'C:\Inventory Management System\Sales Transactions'))
            self.label_sales.config(text=f"Total Sales\n [{str(bill)}]")

            time_ = time.strftime("%I:%M:%S")
            date_ = time.strftime("%d-%m-%Y")
            self.clock_label.config(text=f"My Shop Inventory Management System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
