...
class Sales:
    def __init__(self, root):
        ...
        icon1 = Image.open(r"C:\Inventory Management System\images/clear.png")
        ...
        self.txn_photo = Image.open(r"C:\Inventory Management System\images/sup3.jpg")
...
# ===============================================================
    ...
    #   print(os.listdir('../Inventory Management System')) Transaction1.txt, Category.py
        for i in os.listdir(r'C:\Inventory Management System\Sales Transactions'):
            if i.split('.') [-1] == "txt":
