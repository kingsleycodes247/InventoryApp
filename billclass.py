...
class BillClass:
    def __init__(self, root):
        ...
        self.root.title("MS Inventory Management System  |  Developed By Dreams-Tech Solutions")
        self.root.config(bg="ghostwhite")
        icon_path = (r'C:\Inventory Management System\IMS.ico')
        root.iconbitmap(default=icon_path)
        self.cart_list = []
        self.check_print = 0

        # =======_Title_=========
        img1 = Image.open(r"C:\Inventory Management System\images/logo1.png")
        ...
        # ========_Logout Button_==========
        imgLB = Image.open(r"C:\Inventory Management System\images/logout.png")
        imgLB = imgLB.resize((18, 18), Image.LANCZOS)
        self.photoimgLB = ImageTk.PhotoImage(imgLB)
        logout_btn = Button(self.root, command=self.logout, text="Logout", image=self.photoimgLB, compound=RIGHT,
                            anchor="e",
        ...
        self.clock_label = Label(self.root,
                                 text="My Shop Inventory Management System\t\t Date: DD-MM-YYYY\t\t Time: "
                                      "HH:MM:SS",
        ...
        pTitle = Label(product_frame1, text="All Products", font=("times new roman", 20, "bold"), bg="#262626",
                       fg="white")
        ...
        lab_search = Label(product_frame2, text="Search Product | By Name", font=("times new roman", 15, "bold"),
                           bg="white", fg="green")
        ...
        icon = Image.open(r"C:\Inventory Management System\images/search2.png")
        ...
        search_btn = Button(product_frame2, text="Search", command=self.search, font=("times new roman", 13, "bold"),
                            image=self.photo, padx=8, cursor="hand2", compound=LEFT, anchor="e", bg="#2196f3",
                            fg="white")
        search_btn.place(x=340, y=45, width=95)

        # =======_Show Button Image_==========
        icon1 = Image.open(r"C:\Inventory Management System\images/search.png")
        ...
        show_btn = Button(product_frame2, text="Show All", command=self.show_data, font=("times new roman", 13, "bold"),
                          image=self.photo12, padx=8, cursor="hand2", compound=LEFT, anchor="e", bg="#083531",
                          fg="white")
        ...
        self.txt_cal_input = Entry(cart_calc_frame, textvariable=self.var_cal_input,
                                   font=("times new roman", 15, "bold"), width=31, bd=10, relief=GROOVE,
                                   state="readonly", justify=RIGHT)
        self.txt_cal_input.grid(row=0, columnspan=4)

        btn_7 = Button(cart_calc_frame, text="7", command=lambda: self.get_input(7), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=4, cursor="hand2")
        btn_7.grid(row=1, column=0)

        btn_8 = Button(cart_calc_frame, text="8", command=lambda: self.get_input(8), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=8, cursor="hand2")
        btn_8.grid(row=1, column=1)

        btn_9 = Button(cart_calc_frame, text="9", command=lambda: self.get_input(9), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=8, cursor="hand2")
        btn_9.grid(row=1, column=2)

        btn_sum = Button(cart_calc_frame, text="+", command=lambda: self.get_input("+"), font=("arial", 15, "bold"),
                         bd=5, width=4, pady=18, padx=4, cursor="hand2")
        btn_sum.grid(row=1, column=3)

        btn_4 = Button(cart_calc_frame, text="4", command=lambda: self.get_input(4), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=4,
                       cursor="hand2")
        btn_4.grid(row=2, column=0)

        btn_5 = Button(cart_calc_frame, text="5", command=lambda: self.get_input(5), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=8,
                       cursor="hand2")
        btn_5.grid(row=2, column=1)

        btn_6 = Button(cart_calc_frame, text="6", command=lambda: self.get_input(6), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=18, padx=8,
                       cursor="hand2")
        btn_6.grid(row=2, column=2)

        btn_minus = Button(cart_calc_frame, text="-", command=lambda: self.get_input("-"), font=("arial", 15, "bold"),
                           bd=5, width=4, pady=18, padx=4,
                           cursor="hand2")
        btn_minus.grid(row=2, column=3)

        btn_1 = Button(cart_calc_frame, text="1", command=lambda: self.get_input(1), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=20, padx=4,
                       cursor="hand2")
        btn_1.grid(row=3, column=0)

        btn_2 = Button(cart_calc_frame, text="2", command=lambda: self.get_input(2), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=20, padx=8,
                       cursor="hand2")
        btn_2.grid(row=3, column=1)

        btn_3 = Button(cart_calc_frame, text="3", command=lambda: self.get_input(3), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=20, padx=8,
                       cursor="hand2")
        btn_3.grid(row=3, column=2)

        btn_mul = Button(cart_calc_frame, text="x", command=lambda: self.get_input("*"), font=("arial", 15, "bold"),
                         bd=5, width=4, pady=20, padx=4,
                         cursor="hand2")
        btn_mul.grid(row=3, column=3)

        btn_0 = Button(cart_calc_frame, text="0", command=lambda: self.get_input(0), font=("arial", 15, "bold"), bd=5,
                       width=4, pady=20, padx=4,
                       cursor="hand2")
        btn_0.grid(row=4, column=0)

        btn_c = Button(cart_calc_frame, text="C", command=self.clear, font=("arial", 15, "bold"), bd=5, width=4,
                       pady=20, padx=8,
                       cursor="hand2")
        btn_c.grid(row=4, column=1)

        btn_eq = Button(cart_calc_frame, text="=", command=self.perform_calc, font=("arial", 15, "bold"), bd=5, width=4,
                        pady=20, padx=8,
                        cursor="hand2")
        btn_eq.grid(row=4, column=2)

        btn_div = Button(cart_calc_frame, text="/", command=lambda: self.get_input("/"), font=("arial", 15, "bold"),
                         bd=5, width=4, pady=20, padx=4,
                         cursor="hand2")
        ...
        self.cart_Title = Label(cart_frame, text="Cart \t Total Products: [0]", font=("times new roman", 15),
        ...
        txt_p_name = Entry(cart_widget_frame, textvariable=self.var_pname, font=("times new roman", 15),
        ...
        txt_p_name = Entry(cart_widget_frame, textvariable=self.var_price, font=("times new roman", 15),
                           bg="light yellow", state="readonly")
        ...
        icon5 = Image.open(r"C:\Inventory Management System\images/clear.png")
        icon5 = icon5.resize((23, 19), Image.LANCZOS)
        self.photo5 = ImageTk.PhotoImage(icon5)
        show_btn = Button(cart_widget_frame, text="Clear", command=self.clear_cart,
        ...
        icon6 = Image.open(r"C:\Inventory Management System\images/update.png")
        icon6 = icon6.resize((23, 19), Image.LANCZOS)
        self.photo6 = ImageTk.PhotoImage(icon6)
        show_btn = Button(cart_widget_frame, text="Add | Update", command=self.add_update_cart,
                          font=("times new roman", 13, "bold"),
        ...
        bTitle = Label(billFrame, text="Customer Bill Area", font=("times new roman", 20, "bold"), bg="#262626",
                       fg="white")
        ...
        iconC = Image.open(r"C:\Inventory Management System\images/clear.png")
        iconC = iconC.resize((23, 19), Image.LANCZOS)
        self.photoC = ImageTk.PhotoImage(iconC)
        clearAll_btn = Button(billMenuFrame, text="Clear All", command=self.clear_all,
                              font=("times new roman", 13, "bold"),
        ...
        # ========_Footer_==========
        footer = Label(self.root, text="My Shop - Inventory Management System | "
    ...
    def show_data(self):
        conn = sqlite3.connect(database=r'C:\Inventory Management System/AppDatabase.db')
        cur = conn.cursor()
        try:
    ...
    def add_update_cart(self):
        if self.var_pid.get() == "":
            ...
            for row in self.cart_list:
                ...
                index_ += 1
            if present == "yes":
                op = messagebox.askyesno("Confirmation",
                                         "Product already exist in cart\nDo you want to Update| Remove product from Cart List?",
                                         parent=self.root)
                if op == True:
    ...
    def bill_top(self):
        ...
        bill_top_temp = f'''
\tMS Store Inventory Management System.
...
{str("=" * 47)}\n
    ...
    def update_date_time(self):
        ...
        self.clock_label.config(
            text=f"Super Marche Kado Inventory Management System\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
