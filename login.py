...
class Login:
    def __init__(self,root):
        ...
        self.root.geometry("19200x1080+0+0")
        ...
        self.otp = ""
        # ========Images===========
        imgp = Image.open(r"C:\Inventory Management System\images/phone.png")
        ...
        title = Label(login_frame, text="Inventory Login System", font=("Elephant", 17, "bold"), bg="white", fg="steelblue")
        title.place(x=0, y=25, relwidth=1)

        # ========User Icon===========
        img1 = Image.open(r"C:\Inventory Management System\images/user (1).png")
        ...
        # ========Paasword Icon===========
        img2 = Image.open(r"C:\Inventory Management System\images/user (2).png")
        ...
        img3 = Image.open(r"C:\Inventory Management System\images/login.png")
        ...
        # ==========Animation Images==========
        img01 = Image.open(r"C:\Inventory Management System\images/otp1.jpeg")
        img01 = img01.resize((400, 400), Image.LANCZOS)
        self.im1 = ImageTk.PhotoImage(img01)

        img02 = Image.open(r"C:\Inventory Management System\images/otp4.png")
        img02 = img02.resize((550, 350), Image.LANCZOS)
        self.im2 = ImageTk.PhotoImage(img02)

        img03 = Image.open(r"C:\Inventory Management System\images/otp3.jpeg")
        img03 = img03.resize((400, 400), Image.LANCZOS)
        self.im3 = ImageTk.PhotoImage(img03)

        img05 = Image.open(r"C:\Inventory Management System\images/1.webp")
            ...
            if self.user_id.get() == "":
                ...
                if email == None:
                    ...
                    if chk == 'f':
                        ...
                        img11 = Image.open(r"C:\Inventory Management System\images/save.png")
                        ...
                        img10 = Image.open(r"C:\Inventory Management System\images/update.png")
